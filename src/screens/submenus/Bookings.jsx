...
const Bookings = () => {
    ...
    const tableColumns = (currentPage, rowsPerPage) => [
        ...
        {
            name: <CustomHeader name="Learning License No." />,
            cell: (row) => <span>{row.learningNo}</span>,
        },
        {
            name: <CustomHeader name="First Name" />,
            cell: (row) => <span>{row.fname}</span>,
        },
        {
            name: <CustomHeader name="Middle Name" />,
            cell: (row) => <span>{row.mname}</span>,
        },
        {
            name: <CustomHeader name="Last Name" />,
            cell: (row) => <span>{row.lname}</span>,
        },
        {
            name: <CustomHeader name="Email Id" />,
        ...
        {
            name: <CustomHeader name="Vehicle Type" />,
            cell: (row) => (
                <div style={{ whiteSpace: 'pre-wrap' }}>
                    {row.vehicletype.map((item, id) => (
                        <div key={id}>{item},</div>
                    ))}
                </div>
            )
        ...
        },
        {
            ...
            cell: (row) => <span>{row.slotsession}</span>,
        },
        // {
    ...
    const fetchTeam = async () => {
        ...
        try {
            const response = await instance.get("bookingform/get-bookingforms", {
                headers: {
