...
function Thanksto() {
    ...
    const handleForm = async (e) => {
        ...
        if (validateForm()) {
            ...
            try {
                if (editMode && editId) {
                    await instance.put(`news/update-news/${editId}`, formData);
                    alert('Data updated successfully!');
                } else {
                    await instance.post('news/create-news', formData, {
            ...
            buttons: [
                {
                    ...
                    onClick: async () => {
                        try {
                            await instance.delete(`news/news-delete/${id}`);
    ...
    const toggleActiveStatus = async (id) => {
        try {
            const response = await instance.put(`news/news-status/${id}`);
            if (response.data) {
