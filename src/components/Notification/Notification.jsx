...
function Notification() {
    ...
    const handleForm = async (e) => {
        ...
        if (validateForm()) {
            ...
            try {
                if (editMode && editId) {
                    await instance.put(`notification/notification/${editId}`, formData);
                    alert('Data updated successfully!');
                } else {
                    await instance.post('notification/create-notification', formData);
    ...
    const getdata_admin = () => {
        instance.get('notification/get-notification')
            .then((res) => {
            ...
            buttons: [
                {
                    ...
                    onClick: async () => {
                        try {
                            await instance.delete(`notification/toggle-delete-notification/${id}`);
                            getdata_admin();
                        } catch (error) {
    ...
    const toggleActiveStatus = async (id) => {
        try {
            const response = await instance.put(`notification/toggle-active-notification/${id}`);
            if (response.data) {
